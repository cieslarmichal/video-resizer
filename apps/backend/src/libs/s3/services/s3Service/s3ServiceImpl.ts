...
import { type GetObjectPayload, type S3Service, type PutObjectPayload, type ListObjectsPayload } from './s3Service.js';
...
export class S3ServiceImpl implements S3Service {
  ...
  public async listObjects(payload: ListObjectsPayload): Promise<string[]> {
